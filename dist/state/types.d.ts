 ...
 */
export type Phase = "INACTIVE" | "DOCTOR" | "CONTEXT" | "CLARIFY" | "PLAN" | "BASELINE" | "TEST_WRITE" | "VERIFY_RED" | "IMPL" | "VERIFY_GREEN" | "REFACTOR" | "INSPECT" | "ARCH_GATE" | "REGRESSION_GATE" | "REPORT" | "DONE";
...
export declare function initialState(worktree: string, workflowId: string): WorkflowState;
